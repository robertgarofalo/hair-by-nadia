...
//         icon: <FaPhoneAlt />,
//         title: "Phone",
//         description: '(+61) 0415 545 476',
//     },
//     {
//         icon: <FaEnvelope />,
//         title: "Email",
//         description: 'hello@robertgarofalo.com',
//     },
//     {
//         icon: <FaMapMarkerAlt />,
//         title: "Location",
...
//                         <form ref={form} onSubmit={handleSendEmail} className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
//                             <h3 className="text-4xl text-luxury">Let's work together</h3>
//                             <p className="text-white/60">Have a project in mind or a question to ask? Fill out the form below and I'll be in touch as soon as possible.
//                             </p>
//                             {/* input */}
